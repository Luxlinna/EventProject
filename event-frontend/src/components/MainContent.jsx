...
const MainContent = () => {
  ...
  const fetchEvents = async () => {
    const response = await axios.get('https://event-project-api.vercel.app/api/events');
  ...
  const createEvent = async () => {
    ...
    if (editMode) {
      await axios.put(`https://event-project-api.vercel.app/api/events/${currentEventId}`, formData, {
        headers: { 'Content-Type': 'multipart/form-data' }
      });
      setEditMode(false);
      setCurrentEventId(null);
    } else {
      const response = await axios.post('https://event-project-api.vercel.app/api/events', formData, {
        headers: { 'Content-Type': 'multipart/form-data' }
      });
  ...
  const deleteEvent = async (id) => {
    await axios.delete(`https://event-project-api.vercel.app/api/events/${id}`);
